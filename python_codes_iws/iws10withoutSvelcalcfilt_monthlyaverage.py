...
ratio1=(grad1[:]-meangrad1)/stdgrad1
pl.figure()
pl.plot(ratio1)
print (ratio1[-1])

grad2=height[1:]-height[:-1]
meangrad2=np.mean(grad2)
stdgrad2=np.std(grad2)
ratio2=(grad2[:]-meangrad2)/stdgrad2
pl.figure()
pl.plot(ratio2)
print (ratio2[-1])
#istart=0
